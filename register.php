            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);  ?>" method="POST">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fa-solid fa-envelope me-3 fa-lg"></i>
                    <div class="form-outline flex-fill mb-0">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fa-solid fa-location-dot me-3 fa-lg"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" name="stan" id="stan" class="form-control" />
                      <label class="form-label" for="stan">Broj stana</label>
                    </div>
                  </div>
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <input type="submit" class="btn btn-info btn-lg" name="submit" value="Registruj se">
                  </div>
...
$DatumVremeKreiranja = date('Y-m-d H:i:s');
$UserType = "User";
$PasswordHash = password_hash($Password, PASSWORD_DEFAULT);



$upit="INSERT INTO user (email,passwordHash,ime,prezime,telefon,adresa,stan,datumVremeKreiranja,userType) VALUES('$Email','$PasswordHash','$Ime','$Prezime','$Telefon','$Adresa','$Stan','$DatumVremeKreiranja','$UserType')";
